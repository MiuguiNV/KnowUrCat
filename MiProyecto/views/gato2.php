...
$idGato = 4; // Puedes cambiar este valor según el ID que desees obtener
...
<div class="gato-container">
        <div class="gato">
            <img class="gato3" src="gato2.png" alt="Imagen de gato">
        </div>
        <div class="contenido">
            <?php
...
<form action="gato1.php" method="post">
