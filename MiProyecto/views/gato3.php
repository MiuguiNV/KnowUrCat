...
$idGato = 6; // Puedes cambiar este valor según el ID que desees obtener
...
<head>
    ...
    <style>
        /* Estilos del formulario (puedes seguir usando los estilos anteriores) */
        body {
...
<div class="gato-container">
        <div class="gato">
            <img class="gato3" src="gato3.png" alt="Imagen de gato">
        </div>
        <div class="contenido">
            <?php
...
<form action="gato3.php" method="post">
