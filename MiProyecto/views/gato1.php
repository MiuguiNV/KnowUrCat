...
$idGato = 3; // Puedes cambiar este valor según el ID que desees obtener
...
<body>
    <div class="gato-container">
        <div class="gato">
            <img class="gato3" src="gato1.png" alt="Imagen de gato">
        </div>
        <div class="contenido">
            <?php
